...
var ElementInfo = /** @class */ (function () {
    function ElementInfo(element) {
        var width = (0, mibreit_dom_tools_1.getAttribute)(element, 'width');
        var height = (0, mibreit_dom_tools_1.getAttribute)(element, 'height');
        if (width == null || height == null) {
            throw new Error('ElementInfo#constructor - supported elements need a width and height property');
        }
        var originalStyle = (0, mibreit_dom_tools_1.getAttribute)(element, 'class');
    ...
    ElementInfo.prototype.isElementWithinScrollArea = function () {
        return (0, mibreit_dom_tools_1.isElementWithinWindow)(this._element);
    };
    return ElementInfo;
}());
...
var ElementLoader = /** @class */ (function () {
    function ElementLoader(element) {
        ...
        this._dataSrc = null;
        this._element = element;
        this._dataSrc = (0, mibreit_dom_tools_1.getAttribute)(element, DATA_SRC_ATTRIBUTE);
        var classes = (_a = (0, mibreit_dom_tools_1.getCssClasses)(element)) === null || _a === void 0 ? void 0 : _a.split(',');
    ...
    ElementLoader.prototype._triggerLoad = function () {
        if (this._dataSrc) {
            (0, mibreit_dom_tools_1.setAttribute)(this._element, SRC_ATTRIBUTE, this._dataSrc);
        }
        (0, mibreit_dom_tools_1.removeCssClass)(this._element, LAZY_LOADING_CLASS);
    };
    ElementLoader.prototype._finishLoad = function () {
        var _this = this;
        console.log('ElementLoader#_finishLoad');
        (0, mibreit_dom_tools_1.removeAttribute)(this._element, DATA_SRC_ATTRIBUTE);
        this._state = EImageState.LOADED;
    ...
    ElementLoader.prototype._setBaseStyle = function () {
        (0, mibreit_dom_tools_1.addCssStyle)(this._element, 'opacity', '0');
    };
    ElementLoader.prototype._setLoadingStyle = function () {
        (0, mibreit_dom_tools_1.addCssClass)(this._element, LAZY_LOADING_ANIMATE_CLASS);
    };
    ElementLoader.prototype._setLoadedStyle = function () {
        var _this = this;
        (0, mibreit_dom_tools_1.removeCssStyle)(this._element, 'opacity');
        setTimeout(function () {
            (0, mibreit_dom_tools_1.removeCssClass)(_this._element, LAZY_LOADING_ANIMATE_CLASS);
        }, 1000);
    };
...
var ElementSurrogate = /** @class */ (function () {
    function ElementSurrogate(element, horizontal) {
        ...
        (0, mibreit_dom_tools_1.wrapElements)([element.getHtmlElement()], this._surrogate);
        element.addWasLoadedCallback(function () {
            (0, mibreit_dom_tools_1.unwrapElements)(_this._surrogate);
            (0, mibreit_dom_tools_1.removeElement)(_this._surrogate);
        });
    }
    ...
    ElementSurrogate.prototype.isElementWithinScrollArea = function () {
        return (0, mibreit_dom_tools_1.isElementWithinWindow)(this._surrogate);
    };
    ElementSurrogate.prototype._resize = function (horizontal) {
        console.log('ElementSurrogate#resize', (0, mibreit_dom_tools_1.getElementDimension)(this._surrogate).height, this._element.getWidth(), this._element.getHeight());
        if (horizontal) {
            (0, mibreit_dom_tools_1.addCssStyle)(this._surrogate, 'width', "".concat(((0, mibreit_dom_tools_1.getElementDimension)(this._surrogate).height * this._element.getWidth()) / this._element.getHeight(), "px"));
        }
    ...
    ElementSurrogate.prototype._createSurrogate = function (horizontal) {
        ...
        var surrogate = (0, mibreit_dom_tools_1.createElement)('div');
        (0, mibreit_dom_tools_1.addCssClass)(surrogate, 'mibreit_lazyLoader_surrogate');
        if (horizontal) {
            (0, mibreit_dom_tools_1.overwriteCssStyles)(surrogate, "overflow: hidden; height: 100%; width: ".concat(((0, mibreit_dom_tools_1.getElementDimension)(this._element.getHtmlElement()).height * this._element.getWidth()) /
            ...
            (0, mibreit_dom_tools_1.overwriteCssStyles)(surrogate, "overflow: hidden; width: 100%; height: 0; padding-bottom: ".concat((this._element.getHeight() * 100) / this._element.getWidth(), "%;"));
        }
        return surrogate;
    };
...
var ScrollLoader = /** @class */ (function () {
    ...
    ScrollLoader.prototype.startLoader = function () {
        ...
        (0, mibreit_dom_tools_1.addScrollEventListener)(function (_event) {
            debouncedLoadEvent();
        });
    };
...
function createLazyLoader(elementSelector, config) {
    ...
    var htmlElements = (0, mibreit_dom_tools_1.getElements)(elementSelector);
    var elements = [];
