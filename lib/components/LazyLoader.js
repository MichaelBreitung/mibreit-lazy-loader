            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(index >= 0 && index < this.elementLoaders.length)) return [3 /*break*/, 5];
                        loaded = false;
                    ...
                    case 3:
                        ...
                        loaded = wasLoaded_1;
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/, loaded];
                    case 5: throw new Error("Preloader#loadElement -> invalid Index " + index);
                }
            });
        });
    };
