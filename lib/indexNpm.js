...
var domTools_1 = __webpack_require__(693);
var ElementLoader_1 = __webpack_require__(990);
var Element = /** @class */ (function (_super) {
    __extends(Element, _super);
    function Element(element) {
        var _this = _super.call(this, element) || this;
        _this.width = parseInt(domTools_1.default.getAttribute(element, 'width'));
        _this.height = parseInt(domTools_1.default.getAttribute(element, 'height'));
        return _this;
    }
    ...
    Element.prototype.isElementWithinScrollArea = function () {
        return domTools_1.default.isElementWithinWindow(this.element);
    };
    return Element;
...
var ElementLoader = /** @class */ (function () {
    function ElementLoader(element) {
        ...
        if (!this.element.hasAttribute(exports.DATA_SRC_ATTRIBUTE)) {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.state === EImageState.INACTIVE) {
                _this.element.onload = function () {
                    _this.element.removeAttribute(exports.DATA_SRC_ATTRIBUTE);
                ...
                var dataSrc = domTools_1.default.getAttribute(_this.element, exports.DATA_SRC_ATTRIBUTE);
                domTools_1.default.setAttribute(_this.element, exports.SRC_ATTRIBUTE, dataSrc);
            }
    ...
    ElementLoader.prototype.setBaseStyle = function () {
        domTools_1.default.applyCssClass(this.element, this.originalElementStyle + " " + ElementLoader_module_css_1.default.element_invisible);
    };
    ElementLoader.prototype.setLoadingStyle = function () {
        domTools_1.default.applyCssClass(this.element, this.originalElementStyle + " " + ElementLoader_module_css_1.default.element_animate + " " + ElementLoader_module_css_1.default.element_invisible);
    };
    ElementLoader.prototype.setLoadedStyle = function () {
        var _this = this;
        if (this.originalElementStyle.length > 0) {
            domTools_1.default.applyCssClass(this.element, this.originalElementStyle + " " + ElementLoader_module_css_1.default.element_animate);
            setTimeout(function () {
                domTools_1.default.applyCssClass(_this.element, _this.originalElementStyle);
            }, 1000);
        }
        else {
            domTools_1.default.applyCssClass(this.element, "" + ElementLoader_module_css_1.default.element_animate);
            setTimeout(function () {
                domTools_1.default.applyCssClass(_this.element, null);
            }, 1000);
        }
    };
...
var ScrollLoader = /** @class */ (function () {
    ...
    ScrollLoader.prototype.startLoader = function () {
        ...
        domTools_1.default.addScrollEventListener(function (_event) {
