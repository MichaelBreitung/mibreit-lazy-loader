...
var Element = /** @class */ (function (_super) {
    ...
    function Element(element) {
        ...
        _this.elementInfo = new ElementInfo_1.default(_this.element);
        return _this;
    }
...
var ElementInfo = /** @class */ (function () {
    function ElementInfo(element) {
        ...
        this.width = parseInt(mibreit_dom_tools_1.DomTools.getAttribute(element, 'width'));
        this.height = parseInt(mibreit_dom_tools_1.DomTools.getAttribute(element, 'height'));
    }
...
var ElementSurrogate = /** @class */ (function () {
    function ElementSurrogate(element) {
        this.elementInfo = new ElementInfo_1.default(element);
        this.surrogate = this.createSurrogate();
    }
    ElementSurrogate.prototype.wrap = function (elementHandle) {
        mibreit_dom_tools_1.DomTools.wrapElements([elementHandle], this.surrogate);
    };
    ElementSurrogate.prototype.unwrap = function () {
        mibreit_dom_tools_1.DomTools.unwrapElements(this.surrogate);
        mibreit_dom_tools_1.DomTools.removeElement(this.surrogate);
    };
    ...
    ElementSurrogate.prototype.isElementWithinScrollArea = function () {
        return mibreit_dom_tools_1.DomTools.isElementWithinWindow(this.surrogate);
    };
    ElementSurrogate.prototype.createSurrogate = function () {
        ...
        mibreit_dom_tools_1.DomTools.overwriteCssStyles(surrogate, "overflow: hidden; width: 100%; height: 0; padding-bottom: " + (this.elementInfo.getHeight() * 100) / this.elementInfo.getWidth() + "%;");
        return surrogate;
    };
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Element = exports.createLazyLoader = void 0;
var createLazyLoader_1 = __webpack_require__(194);
Object.defineProperty(exports, "createLazyLoader", ({ enumerable: true, get: function () { return createLazyLoader_1.createLazyLoaderFromElements; } }));
...
function createLazyLoaderFromElements(htmlElements, config) {
    var elements = [];
    var _loop_1 = function (i) {
        var element = new Element_1.default(htmlElements[i]);
        elements.push(element);
        if (config.useSurrogate) {
            var surrogate_1 = new ElementSurrogate_1.default(htmlElements[i]);
            surrogate_1.wrap(htmlElements[i]);
...
function default_1(elementSelector, config) {
    return createLazyLoaderFromElements(mibreit_dom_tools_1.DomTools.getElements(elementSelector), config);
}
